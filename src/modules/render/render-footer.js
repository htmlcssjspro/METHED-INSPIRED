...
const $catalog = createElement('div', {
    ...
    innerHTML: '<h2 class="footer__title catalog__main-title">Каталог</h2>',
}, {
    parent: $footerContainer
});

const $catalogMainList = createElement('ul', {
    className: 'catalog__main-list',
}, {
    parent: $catalog,
});
...
const $social = createElement('div', {
    className: 'footer__item footer__item_social social',
    innerHTML: `
...
const $contacts = createElement('div', {
    className: 'footer__item footer__item_contacts contacts',
    innerHTML: '<h2 class="footer__title contacts__title visually-hidden">Контакты</h2>',
}, {
    parent: $footerContainer,
    append: createElement('ul', {
...
const $developer = createElement('div', {
    className: 'footer__item footer__item_developer developer',
}, {
    parent: $footerContainer,
    append: createElement('ul', {
        className: 'developer__list',
    }, {
        append: [
            createElement('li', {
            ...
            createElement('li', {
                ...
                append: createElement('a', {
                    className:   'developer__link',
                    href:        'https://t.me/militer_htmlcssjspro',
                    textContent: 'Сергей MILITER',
                })
            }),
        ]
    })
...
export default function renderFooter() {
    console.log('renderFooter()'); // TODO Delete

    $catalogMainList.textContent = '';

    for (const gender in DATA.navigation) {
        const $catalogMainItem = createElement('li', {
